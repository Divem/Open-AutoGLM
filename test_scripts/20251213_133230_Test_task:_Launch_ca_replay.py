...
Generated on: 2025-12-13T13:32:30.777491

To run this script:
    python 20251213_133230_Test_task:_Launch_ca_replay.py
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python 20251213_133230_Test_task:_Launch_ca_replay.py <script_file.json>")
        sys.exit(1)
