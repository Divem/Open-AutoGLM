...
Generated on: 2025-12-14T21:45:36.804371

To run this script:
    python 20251214_214536_打开相机，拍一张照片，然后回到桌面_replay.py
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python 20251214_214536_打开相机，拍一张照片，然后回到桌面_replay.py <script_file.json>")
        sys.exit(1)
