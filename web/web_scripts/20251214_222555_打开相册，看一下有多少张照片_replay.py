...
Generated on: 2025-12-14T22:25:55.062721

To run this script:
    python 20251214_222555_打开相册，看一下有多少张照片_replay.py
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python 20251214_222555_打开相册，看一下有多少张照片_replay.py <script_file.json>")
        sys.exit(1)
