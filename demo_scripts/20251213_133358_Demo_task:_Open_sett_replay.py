...
Generated on: 2025-12-13T13:33:58.635045

To run this script:
    python 20251213_133358_Demo_task:_Open_sett_replay.py
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python 20251213_133358_Demo_task:_Open_sett_replay.py <script_file.json>")
        sys.exit(1)
