...
Generated on: 2025-12-13T13:36:13.166843

To run this script:
    python 20251213_133613_打开设置调整音量到最大_replay.py
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python 20251213_133613_打开设置调整音量到最大_replay.py <script_file.json>")
        sys.exit(1)
